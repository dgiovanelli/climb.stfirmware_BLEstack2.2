...
@set BIM_PATH=..\..\..\util\bim\cc1350em\iar\FlashOnly\Exe

::Set BIM image
@set BIM_IMG=bim_cc1350em_bim.hex

:: Set application name
@set APP_NAME=dual_image_concept

:: Calculate file names
@set STACK_IMG=%APP_NAME%_cc1350em_stack.hex
@set APP_IMG=%APP_NAME%_cc1350em_app.hex
